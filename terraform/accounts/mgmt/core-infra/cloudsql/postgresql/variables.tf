...
variable "psql_activation_policy" {
  description = "This specifies when the instance should be active. Can be either ALWAYS, NEVER or ON_DEMAND"
  type        = string
}
variable "psql_availability_type" {
  description = "The availability type of the Cloud SQL instance, high availability (REGIONAL) or single zone (ZONAL)"
  type        = string
}
variable "psql_retained_backups" {
  description = "Number of backups to retain"
  type        = number
}
variable "psql_retention_unit" {
  description = "The unit that 'retainedBackups' represents. Defaults to COUNT"
  type        = string
}
variable "psql_binary_log_enabled" {
...
*/
variable "psql_authorized_network_name" {
  description = "Name of the authorized network"
  type        = string
}
variable "psql_authorized_network_value" {
