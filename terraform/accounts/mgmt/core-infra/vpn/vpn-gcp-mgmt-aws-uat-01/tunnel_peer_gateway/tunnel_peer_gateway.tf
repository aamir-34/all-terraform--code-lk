module "tunnel_peer_gateway" {
  ...
  external_vpn_gateway_interfaces = {
    ...
    "2" = {
      router_int_name       = var.router_int_name3
      router_peer_name      = var.router_peer_name3
      name_tunnel           = var.name_tunnel_3
      tunnel_address        = var.vir_pvt_gat_out_ip_address_3
      vgw_inside_address    = var.vir_pvt_gat_ins_ip_add_3
      asn                   = var.vir_pvt_gat_asn
      cgw_inside_address    = var.cus_gat_ins_ip_add_3
      shared_secret         = var.shared_secret_tunnel_3
      vpn_gateway_interface = 1
    },
    "3" = {
      router_int_name       = var.router_int_name4
      router_peer_name      = var.router_peer_name4
      name_tunnel           = var.name_tunnel_4
      tunnel_address        = var.vir_pvt_gat_out_ip_address_4
      vgw_inside_address    = var.vir_pvt_gat_ins_ip_add_4
      asn                   = var.vir_pvt_gat_asn
      cgw_inside_address    = var.cus_gat_ins_ip_add_4
